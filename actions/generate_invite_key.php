...
if(!in_array($aUserData['user']['type'], ['admin','developer','moderator'])) throw new Exception('Unauthorized');

$oResp->invite_key = API::_()->generateInviteKey(API::_()->getUserId(Post::_()->get('email')));
